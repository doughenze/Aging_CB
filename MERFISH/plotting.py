...
major_cell_types = {
    ...
    "CB GABA" : "cornflowerblue",
    "CB Sero" : "mediumpurple",
    
    # immune cells + microglia -- pink
    "Microglia" : "pink",
    "Bergmann glia" : "deeppink",
    "MB Dopa" : "violet",
    ...
    "Endo" : "khaki",
    "Immune" : "goldenrod",
    "Ependymal cells" : "darkkhaki",
    
    # Oligodendrocytes
    "Oligodendrocytes" : "slategrey",
    "OPC" : "black",
    "OEG" : "green",
    "Oligo" : "mediumslateblue",
    "Vascular": "rebeccapurple",
    
    'HY GABA': "darkorange",
    'CNU-HYa GABA': "dodgerblue",
    'MOB-CR Glut': "mediumslateblue",
    'MY GABA': "rebeccapurple",
    ...
    'CGE GABA': "burlywood",
    'MOB-DG-IMN': "slategrey",

    'CNU GABA': "navy",
    'LSX GABA': "firebrick",

    'MGE GABA': "crimson",
    'MB-HB Sero': "goldenrod",
...
def generate_palettes(A,clust_key="clust_annot", cell_type_key="cell_type"):
    ...
    for i,c in enumerate(iter(celltype_pals)):
        celltype_colors[uniq_celltypes[i-1]] = c['color']
