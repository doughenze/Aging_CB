...
scRNA.merge.integrated@meta.data$cell_type_age <-
  paste(scRNA.merge.integrated@meta.data$celltype_refined,
...
for (cell_type_to_test in unique(scRNA.merge.integrated$celltype_refined)) {
  ...
  save(results_list_scRNA.merge.integrated, 
       file='Nucseq_cer_AgingDEGs_results_full_rev.bin')
}
